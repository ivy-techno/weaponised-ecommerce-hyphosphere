...
export default function Home() {
  ...
  const handleSurfaceClick = useCallback((event: ReactMouseEvent<HTMLElement>) => {
    ...
    const isReveal = target.dataset.sound === 'reveal' || target.matches('.follow-button, .orientation-cta, .terrain-tile, .stack-learning-layer, .stack-step-button, .thread-step-card, .source-thumbnail-button, .source-example-button, .source-profile-button, .search-preview-button, .search-inspect-button, .possible-output-type-card');
