...
function CorpusView({ mode, selectedId, onSelect, onOpenEvidence, onOpenExample, onOpenCollection, onChangeMode }: { mode: 'concepts' | 'artifacts'; selectedId: string; onSelect: (id: string) => void; onOpenEvidence: (id: string) => void; onOpenExample: (id: string) => void; onOpenCollection: (id: string) => void; onChangeMode: (mode: 'concepts' | 'artifacts') => void }) {
