      ...
      <div className="workspace-grid">
        <aside className={`sidebar ${mobileNavOpen ? 'is-open' : ''}`}>
          <div className="sidebar-scroll">
            ...
            <nav className="view-nav corpus-nav" aria-label="WE repository">
              <button className={view === 'concepts' ? 'is-active' : ''} onClick={() => changeView('concepts')}><Sparkles size={16} /> <span>WE concepts</span><small>04</small></button>
              <button className={view === 'artifacts' ? 'is-active' : ''} onClick={() => changeView('artifacts')}><Archive size={16} /> <span>WE artifacts</span><small>07</small></button>
            </nav>
