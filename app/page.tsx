...
function AgentBriefSurface({ onOpenExample, onOpenCollection, onOpenEvidence, onOpenOutputs, onSaveBrief, agentRequest, onBriefStateChange }: { onOpenExample: (sourceId: string) => void; onOpenCollection: (sourceId: string) => void; onOpenEvidence: (nodeId: string) => void; onOpenOutputs: () => void; onSaveBrief: (snapshot: AgentBriefSnapshot) => void; agentRequest?: AgentBriefRequest | null; onBriefStateChange?: (snapshot: AgentBriefSnapshot) => void }) {
...
export default function Home() {
  ...
  useEffect(() => {
    const refreshScrollPrompt = () => {
      ...
      const modalOpen = evidenceOpen || stackOpen || Boolean(collectionSourceId) || Boolean(exampleSourceId) || notebookOpen || Boolean(conceptDetailLabel) || Boolean(stackLayerDetailLabel) || Boolean(possibleOutputExampleCode);
  ...
  }, [collectionSourceId, conceptDetailLabel, evidenceOpen, exampleSourceId, mobileNavOpen, notebookOpen, possibleOutputExampleCode, stackLayerDetailLabel, stackOpen, view]);
    ...
    <main className="app-shell" onClickCapture={handleSurfaceClick}>
      ...
      <div className="workspace-grid">
        ...
        <section className="main-stage">
          ...
          <ResearchPrimer />
          <AgentBriefSurface onOpenExample={openExample} onOpenCollection={openCollection} onOpenEvidence={openEvidence} onOpenOutputs={() => changeView('outputs')} onSaveBrief={saveAgentBrief} agentRequest={agentBriefRequest} onBriefStateChange={handleBriefStateChange} />
